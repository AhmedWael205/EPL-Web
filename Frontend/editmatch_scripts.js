    ...
    xhr.onreadystatechange = function () { 
        if (xhr.readyState === 4 && xhr.status === 200) { 
            ...
            $('#confirm').on('click',function(){
                ...
                var html='<label>Home Team</label> <select class="inputform" id="selType1"name="HomeTeam"> <option value="ENPPI"selected>ENPPI</option> <option value="Aswan">Aswan</option> <option value="El Gaish">El Gaish</option> <option value="El Gouna">El Gouna</option> <option value="El Entag El Harby">El Entag El Harby</option> <option value="Ceramica Cleopatra">Ceramica Cleopatra</option> <option value="National Bank">National Bank</option> <option value="Wadi Degla">Wadi Degla</option> <option value="Pyramids">Pyramids</option> <option value="Al Ittihad">Al Ittihad</option> <option value="Al Mokawloon">Al Mokawloon</option> <option value="Zamalek">Zamalek</option> <option value="Al Masry">Al Masry</option> <option value="Ismaily">Ismaily</option> <option value="Al Ahly">Al Ahly</option> <option value="Misr lel Makkasa">Misr lel Makkasa</option> <option value="Somouha">Somouha</option> <option value="Ghazl El Mahalla">Ghazl El Mahalla</option> </select><br><br>';
                html+='<label>Away Team</label ><select class="inputform" id="selType2"name="HomeTeam"><option value="ENPPI"selected>ENPPI</option><option value="Aswan">Aswan</option><option value="El Gaish">El Gaish</option><option value="El Gouna">El Gouna</option><option value="El Entag El Harby">El Entag El Harby</option><option value="Ceramica Cleopatra">Ceramica Cleopatra</option><option value="National Bank">National Bank</option><option value="Wadi Degla">Wadi Degla</option><option value="Pyramids">Pyramids</option><option value="Al Ittihad">Al Ittihad</option><option value="Al Mokawloon">Al Mokawloon</option><option value="Zamalek">Zamalek</option><option value="Al Masry">Al Masry</option><option value="Ismaily">Ismaily</option><option value="Al Ahly">Al Ahly</option><option value="Misr lel Makkasa">Misr lel Makkasa</option><option value="Somouha">Somouha</option><option value="Ghazl El Mahalla">Ghazl El Mahalla</option></select><br><br>';
